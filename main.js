...
global.authFile = `OptimusKchaRico`;
...
let prekey = []
let directorio = readdirSync("./OptimusKchaRico")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-') /*|| file.startsWith('session-') || file.startsWith('sender-') || file.startsWith('app-') */
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./OptimusKchaRico/${files}`)
})
} 
...
const directories = ['./OptimusKchaRico/', './jadibts/']
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '𝗘𝘆 @user 𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗼 𝗔 𝗘𝘀𝘁𝗲 𝗚𝗿𝘂𝗽𝗼 𝗥𝗲𝗰𝗶𝗲𝗿𝗱𝗮 𝗹𝗲𝗲𝗿 𝗟𝗮 𝗗𝗲𝘀𝗰𝗿𝗶𝗽𝗰𝗶𝗼𝗻 𝗬 𝗘𝘃𝗶𝘁𝗮 𝗦𝗲𝗿 𝗦𝗮𝗰𝗮𝗱𝗼 ꨄ';
  conn.bye = '@user 𝗡𝗶 𝗗𝗲 𝗔𝗱𝗼𝗿𝗻𝗼 𝗡𝗼𝘀 𝗦𝗲𝗿𝘃𝗶𝘀𝘁𝗲 𝗘𝗻 𝗘𝗹 𝗚𝗿𝘂𝗽𝗼 ꨄ';
  conn.spromote = '@user 𝗘𝘀𝘁𝗲 𝗦𝗲𝗿 𝗛𝘂𝗺𝗮𝗻𝗼 𝗦𝗲 𝗛𝗮 𝗩𝘂𝗲𝗹𝘁𝗼 𝗔𝗱𝗺𝗶𝗻 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 ꨄ';
  conn.sdemote = '@user 𝗘𝘀𝘁𝗲 𝗦𝗲𝗿 𝗛𝘂𝗺𝗮𝗻𝗼 𝗬𝗮 𝗡𝗼 𝗘𝘀 𝗔𝗱𝗺𝗶𝗻 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 ꨄ';
  conn.sDesc = '𝗟𝗮 𝗗𝗲𝘀𝗰𝗿𝗶𝗽𝗰𝗶𝗼𝗻 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 𝗦𝗲 𝗛𝗮 𝗖𝗮𝗺𝗯𝗶𝗮𝗱𝗼 ꨄ';
  conn.sSubject = '𝗘𝗹 𝗡𝗼𝗺𝗯𝗿𝗲 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 𝗛𝗮 𝗦𝗶𝗱𝗼 𝗖𝗮𝗺𝗯𝗶𝗮𝗱𝗼 ꨄ';
  conn.sIcon = '𝗟𝗮 𝗙𝗼𝘁𝗼 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 𝗛𝗮 𝗦𝗶𝗱𝗼 𝗖𝗮𝗺𝗯𝗶𝗮𝗱𝗼 ꨄ';
  conn.sRevoke = '𝗘𝗹 𝗟𝗶𝗻𝗸 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼 𝗛𝗮 𝗦𝗶𝗱𝗼 𝗖𝗮𝗺𝗯𝗶𝗮𝗱𝗼 ꨄ';
...
setInterval(async () => {
  ...
  const bio = `〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕💻 VENTA DE BOT PERZONALIZADOS ⏳ Uptime: ${uptime}`;
